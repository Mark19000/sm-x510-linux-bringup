...
- **Changed** (85):
  ...
  - … and 35 more (see JSON).

## DTS Matrix U3 ↔ U11 ↔ EZE4
...
Binary DTBs detected but not compared semantically:

- `<project-root>/artifacts/stock/dt/recovery/fdt-00-offset-044a6080.dtb`: binary DTB; provides decompiled DTS for semantic comparison
- `<project-root>/artifacts/stock/dt/recovery/fdt-01-offset-044d221c.dtb`: binary DTB; provides decompiled DTS for semantic comparison
- `<project-root>/artifacts/stock/dt/recovery/fdt-02-offset-044fe3b8.dtb`: binary DTB; provides decompiled DTS for semantic comparison
- `<project-root>/artifacts/stock/dt/recovery/fdt-03-offset-0452b040.dtb`: binary DTB; provides decompiled DTS for semantic comparison
- `<project-root>/artifacts/stock/dt/vendor_boot/fdt-00-offset-0113f040.dtb`: binary DTB; provides decompiled DTS for semantic comparison
